...
**Status note:** This is the lock five-minute product story. The functionality described is the V1 target; Phase 1 is foundation only and none of the pipeline is implemented yet.
